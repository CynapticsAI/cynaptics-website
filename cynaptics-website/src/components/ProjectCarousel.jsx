          ...
          {Projects.map((ele, index) => {
            return (
              <div className="carousel-item " key={ele.id}>
                ...
                >
                  <div className="hidden lg:block   bg-black shadow-[10px_10px_10px_10px] shadow-white text-center  overflow-hidden group !transition-all !fade-in-out">
                    <div className="card  !w-full !h-full left-[0]">
                      <div className="content !w-full !h-full">
                        ...
                        <div className="back hidden lg:block !w-full !h-full lg:relative lg:group transition-all fade-in-out">
                          <Image
                            placeholder="blur"
                            className="h-full w-full absolute r z-[-1]  brightness-150 "
                            src={ele.display_image}
                            alt="loading..."
                          />
                          <div className="md:text-xl backdrop-blur-[2px]  bg-black/70 h-full w-full   !text-white   relative  p-10 z-[1000]  transition-all fade-in-out">
                            ...
                            <div className="hidden lg:block ">
                              {parse(
                                ele.display_desc ? ele.display_desc : ele.desc1
                              )}{" "}
                              ...
                            </div>
                          </div>
                  ...
                  <div className="carousel-box hover:border-2 lg:hidden bg-black shadow-[10px_10px_10px_10px] shadow-white text-center relative overflow-hidden group !transition-all !fade-in-out">
                    <div className="!mx-auto title !bg-black !w-full  md:pt-auto text-center flex flex-col my-auto items-center lg::absolute !bottom-0 lg:!bottom-[-300px] lg:rounded-t-[40px] lg:!h-fit group-hover:!bottom-[0] z-[1100] !transition-all !fade-in-out">
                      <div className="md:text-xl text-sm p-5 ">
                        <div className="font-bold">{ele.project_title}</div>
                        <br />
                        <div className="hidden lg:block">
