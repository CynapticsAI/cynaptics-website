...
const Carousel = ({ children }) => {
	...
	return (
		<div className="carousel h-[10rem] w-[10rem] lg:w-[50rem] lg:h-[50rem]">
			{active > 0 && (
				<button className="nav left lg:!top-[25%] !w-7 !h-7 md:!w-auto md:!h-auto !right-[140px] sm:!right-auto" onClick={() => setActive((i) => i - 1)}>
			...
			{active < count - 1 && (
				<button className="nav right lg:!top-[25%] !w-7 !h-7 md:!w-auto md:!h-auto !left-[140px] sm:!left-auto" onClick={() => setActive((i) => i + 1)}>
