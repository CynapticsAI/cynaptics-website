...
export default function PongGame() {
	...
	return (
		<div id="body" className="mx-auto justify-center">
			<p className="text-center my-3 font-bold tetx-xl">Control the left player by using up and down arrow keys</p>
			<div className="w-full flex justify-center">
			<canvas className="border-2 border-black !w-full !h-full md:!w-[800px] md:!h-[500px] "></canvas>
			</div>
