				...
				<div className="container   mx-auto flex flex-col">
					<div className="lg:w-4/6 mx-auto">
						<div className="rounded-lg overflow-hidden mx-10 md:mx-auto">
							<Image width={500} height={500} alt="content" placeholder="blur" className="object-cover object-center h-full w-full" src={AboutUs1} />
						</div>
						<div className="flex flex-col sm:flex-row mt-10 mx-10 ">
							<div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
								<div className="w-20 h-20 rounded-full inline-flex items-center justify-center bg-gray-200 text-gray-400">
									<Image src={AboutUs2} className="rounded-full" placeholder="blur" />
								</div>
								<div className="flex flex-col items-center text-center justify-center">
									<h2 className="font-medium title-font mt-4 text-white text-lg">The Cynaptics Club</h2>
							...
							<div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
								<p className="leading-relaxed text-lg mb-4"><TypeAnimation
					...
					<div className="my-10 mx-20 text-md md:text-lg text-center md:text-start">
					<TypeAnimation
