...
import Brain from "@/components/Model";
	...
	useEffect(() => {
		...
		function getEdgePos(i, offset) {
			...
			var pos = createVector(
				offset * hexDoubleLineOffset * 0.5,
				-hexHeight / 2
			);
		...
		class Hex {
			...
			update() {
				...
				if (this.zenosNeighbours == 0) {
					...
					this.zenosNeighbours =
						this.zenosNeighbours * (1 - zenoSway) +
						zenoSway * (this.countActiveNeighbours() + this.active);
				}
			...
			drawLines() {
				...
				if (this.active) {
					...
					// four neighbours
						...
						let skipped2 =
							activeNeighbours.slice(skipped1 + 1).indexOf(false) +
							skipped1 +
							1;
			...
			drawCurveBetweenEdges(edge1, edge2) {
				...
				if (double) {
					...
					this.drawCurveWithOffset(
						edge1,
						edge2,
						1,
						1,
						-hexDoubleLineOffset * 0.8
					);
					this.drawCurveWithOffset(
						edge1,
						edge2,
		...
		<div>
			...
			<ul className="keyboard">
				<Image
					...
					src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/2361/keyboard.svg"
				/>
				<li className="keyboard__item">
					wipe the board<span className="keyboard__key">W</span>
				</li>
				<li className="keyboard__item">
					kill all agents<span className="keyboard__key">Q</span>
				</li>
				<li className="keyboard__item">
					toggle agent visibility<span className="keyboard__key">T</span>
				</li>
				<li className="keyboard__item">
					toggle mouse visibility<span className="keyboard__key">M</span>
				</li>
				<li className="keyboard__item">
					toggle hexagon visibility<span className="keyboard__key">H</span>
				</li>
				<li className="keyboard__item">
					toggle grid visibility<span className="keyboard__key">G</span>
				</li>
				<li className="keyboard__item">
					add a creator<span className="keyboard__key">C</span>
				</li>
				<li className="keyboard__item">
					add a destroyer<span className="keyboard__key">D</span>
				</li>
				<li className="keyboard__item">
					pause/unpause agents<span className="keyboard__key">Space</span>
				</li>
				<li className="keyboard__item">
					draw<span className="keyboard__key">Click</span>
				</li>
			</ul>
			{/* <div className='grid grid-cols-[600px_auto] h-screen text-center items-center z-[100]'>
				<div className=" ">
